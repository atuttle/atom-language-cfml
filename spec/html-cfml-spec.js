    ...
    describe('populating a select list', function() {
        xit('should tokenize correctly', function() {
            ...
            expect(tokens[2][0]).toEqual({
                value: '    ',
                scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml']
            });
            ...
            expect(tokens[3][15]).toEqual({
                value: 'country',
                scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'variable.other.object.cfml']
            });
