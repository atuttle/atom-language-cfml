describe('html-cfml grammar', function() {
    ...
    describe('tokenizing cfcomments', function() {
        ...
        it('should tokenize cfcomments embedded in html tags correctly', function() {
            ...
            expect(tokens[0][0]).toEqual({ value: '<', scopes: ['text.html.cfml', 'meta.tag.inline.input.html', 'punctuation.definition.tag.begin.html'] });
            expect(tokens[0][1]).toEqual({ value: 'input', scopes: ['text.html.cfml', 'meta.tag.inline.input.html', 'entity.name.tag.inline.input.html'] });
            expect(tokens[0][2]).toEqual({ value: ' ', scopes: ['text.html.cfml', 'meta.tag.inline.input.html'] });
            expect(tokens[0][3]).toEqual({ value: 'type', scopes: ['text.html.cfml', 'meta.tag.inline.input.html', 'meta.attribute-with-value.html', 'entity.other.attribute-name.html'] });
            expect(tokens[0][4]).toEqual({ value: '=', scopes: ['text.html.cfml', 'meta.tag.inline.input.html', 'meta.attribute-with-value.html', 'punctuation.separator.key-value.html'] });
            expect(tokens[0][5]).toEqual({ value: '"', scopes: ['text.html.cfml', 'meta.tag.inline.input.html', 'meta.attribute-with-value.html', 'string.quoted.double.html', 'punctuation.definition.string.begin.html'] });
            expect(tokens[0][6]).toEqual({ value: 'text', scopes: ['text.html.cfml', 'meta.tag.inline.input.html', 'meta.attribute-with-value.html', 'string.quoted.double.html'] });
            expect(tokens[0][7]).toEqual({ value: '"', scopes: ['text.html.cfml', 'meta.tag.inline.input.html', 'meta.attribute-with-value.html', 'string.quoted.double.html', 'punctuation.definition.string.end.html'] });
            expect(tokens[0][8]).toEqual({ value: ' ', scopes: ['text.html.cfml', 'meta.tag.inline.input.html'] });
            expect(tokens[0][9]).toEqual({ value: 'name', scopes: ['text.html.cfml', 'meta.tag.inline.input.html', 'meta.attribute-with-value.html', 'entity.other.attribute-name.html'] });
            expect(tokens[0][10]).toEqual({ value: '=', scopes: ['text.html.cfml', 'meta.tag.inline.input.html', 'meta.attribute-with-value.html', 'punctuation.separator.key-value.html'] });
            expect(tokens[0][11]).toEqual({ value: '"', scopes: ['text.html.cfml', 'meta.tag.inline.input.html', 'meta.attribute-with-value.html', 'string.quoted.double.html', 'punctuation.definition.string.begin.html'] });
            expect(tokens[0][12]).toEqual({ value: 'credit_card_number', scopes: ['text.html.cfml', 'meta.tag.inline.input.html', 'meta.attribute-with-value.html', 'string.quoted.double.html'] });
            expect(tokens[0][13]).toEqual({ value: '"', scopes: ['text.html.cfml', 'meta.tag.inline.input.html', 'meta.attribute-with-value.html', 'string.quoted.double.html', 'punctuation.definition.string.end.html'] });
            expect(tokens[0][14]).toEqual({ value: ' ', scopes: ['text.html.cfml', 'meta.tag.inline.input.html'] });
            expect(tokens[0][15]).toEqual({ value: '<!--- embedded cfcomment --->', scopes: ['text.html.cfml', 'meta.tag.inline.input.html', 'comment.line.cfml'] });
            expect(tokens[0][16]).toEqual({ value: ' />', scopes: ['text.html.cfml', 'meta.tag.inline.input.html', 'punctuation.definition.tag.end.html'] });
        });
        ...
        it('should not highlight hash signs in cfcomments', function() {
            ...
            expect(tokens[0][13]).toEqual({ value: '"', scopes: ['text.html.cfml', 'meta.tag.inline.input.html', 'meta.attribute-with-value.html', 'string.quoted.double.html', 'punctuation.definition.string.end.html'] });
            expect(tokens[0][14]).toEqual({ value: ' ', scopes: ['text.html.cfml', 'meta.tag.inline.input.html'] });
            expect(tokens[0][15]).toEqual({ value: '<!--- #rc.name# should not be tokenized --->', scopes: ['text.html.cfml', 'meta.tag.inline.input.html', 'comment.line.cfml'] });
            expect(tokens[0][16]).toEqual({ value: ' />', scopes: ['text.html.cfml', 'meta.tag.inline.input.html', 'punctuation.definition.tag.end.html'] });
        });
    });
    ...
    describe('tokenization in strings', function() {
        ...
        xit('should tokenize embedded cf in strings', function() {
            ...
            expect(tokens[0][1]).toEqual({ value: 'cfoutput', scopes: ['text.html.cfml', 'meta.tag.cfml', 'entity.name.tag.cfml'] });
            // expect(tokens[0][2]).toEqual({ value: '>', scopes: ['text.html.cfml', 'meta.tag.cfml', 'punctuation.definition.tag.end.cfml'] });
            expect(tokens[0][3]).toEqual({ value: '<', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.inline.a.html', 'punctuation.definition.tag.begin.html'] });
            expect(tokens[0][4]).toEqual({ value: 'a', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.inline.a.html', 'entity.name.tag.inline.a.html'] });
            expect(tokens[0][5]).toEqual({ value: ' ', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.inline.a.html'] });
            expect(tokens[0][6]).toEqual({ value: 'href', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.inline.a.html', 'entity.other.attribute-name.html'] });
            expect(tokens[0][7]).toEqual({ value: '=', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.inline.a.html'] });
            expect(tokens[0][8]).toEqual({ value: '"', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.inline.a.html', 'string.quoted.double.html', 'punctuation.definition.string.begin.html'] });
            expect(tokens[0][9]).toEqual({ value: 'index.cfm?action=shopping.product-details.main', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.inline.a.html', 'string.quoted.double.html'] });
            expect(tokens[0][10]).toEqual({ value: '&', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.inline.a.html', 'string.quoted.double.html', 'constant.character.entity.html', 'punctuation.definition.entity.html'] });
            expect(tokens[0][11]).toEqual({ value: 'amp', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.inline.a.html', 'string.quoted.double.html', 'constant.character.entity.html'] });
            expect(tokens[0][12]).toEqual({ value: ';', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.inline.a.html', 'string.quoted.double.html', 'constant.character.entity.html', 'punctuation.definition.entity.html'] });
            expect(tokens[0][13]).toEqual({ value: 'details=', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.inline.a.html', 'string.quoted.double.html'] });
            expect(tokens[0][14]).toEqual({ value: '#', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.inline.a.html', 'string.quoted.double.html', 'constant.character.hash.cfml'] });
            expect(tokens[0][15]).toEqual({ value: '_', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.inline.a.html', 'string.quoted.double.html', 'variable.other.object.cfml'] });
            expect(tokens[0][16]).toEqual({ value: '.', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.inline.a.html', 'string.quoted.double.html', 'keyword.operator.accessor.cfml'] });
            expect(tokens[0][17]).toEqual({ value: 'detail', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.inline.a.html', 'string.quoted.double.html', 'meta.property.object.cfml'] });
            expect(tokens[0][18]).toEqual({ value: '#', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.inline.a.html', 'string.quoted.double.html', 'constant.character.hash.cfml'] });
            expect(tokens[0][19]).toEqual({ value: '"', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.inline.a.html', 'string.quoted.double.html', 'punctuation.definition.string.end.html'] });
            expect(tokens[0][20]).toEqual({ value: '>', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.inline.a.html', 'punctuation.definition.tag.end.html'] });
            ...
            expect(tokens[0][34]).toEqual({ value: '</', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.inline.a.html', 'punctuation.definition.tag.begin.html'] });
            expect(tokens[0][35]).toEqual({ value: 'a', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.inline.a.html', 'entity.name.tag.inline.a.html'] });
            expect(tokens[0][36]).toEqual({ value: '>', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.inline.a.html', 'punctuation.definition.tag.end.html'] });
    ...
    xit('should tokenize cfml in unquoted attributes', function() {
        ...
        expect(tokens[0][1]).toEqual({ value: 'cfoutput', scopes: ['text.html.cfml', 'meta.tag.cfml', 'entity.name.tag.cfml'] });
        // expect(tokens[0][2]).toEqual({ value: '>', scopes: ['text.html.cfml', 'meta.tag.cfml', 'punctuation.definition.tag.end.cfml'] });
        expect(tokens[0][3]).toEqual({ value: '<', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.span.html', 'punctuation.definition.tag.html'] });
        expect(tokens[0][4]).toEqual({ value: 'span', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.span.html', 'entity.name.tag.html'] });
        expect(tokens[0][5]).toEqual({ value: ' ', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.span.html'] });
        expect(tokens[0][6]).toEqual({ value: 'class', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.span.html', 'entity.other.attribute-name.html'] });
        expect(tokens[0][7]).toEqual({ value: '=', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.span.html'] });
        expect(tokens[0][8]).toEqual({ value: '#className#', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.span.html', 'string.unquoted.html'] });
        expect(tokens[0][9]).toEqual({ value: '>', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.span.html', 'punctuation.definition.tag.html'] });
        expect(tokens[0][10]).toEqual({ value: '<', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.span.html', 'punctuation.definition.tag.html', 'meta.scope.between-tag-pair.html'] });
        expect(tokens[0][11]).toEqual({ value: '/', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.span.html', 'punctuation.definition.tag.html'] });
        expect(tokens[0][12]).toEqual({ value: 'span', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.span.html', 'entity.name.tag.html'] });
        expect(tokens[0][13]).toEqual({ value: '>', scopes: ['text.html.cfml', 'meta.scope.cfoutput.cfml', 'meta.tag.span.html', 'punctuation.definition.tag.html'] });
